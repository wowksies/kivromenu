   ...
   w("Alerts", "https://res.cloudinary.com/dhiws7ac5/image/upload/v1743434255/alerts_dsucpi.png", C.alerts, !0),
    ...
    const css = `
        #kivro-menu-v2 {
            ...
            transition: width 0.4s cubic-bezier(0.2, 0.8, 0.2, 1), height 0.4s cubic-bezier(0.2, 0.8, 0.2, 1), opacity 0.3s ease;
            overflow: hidden;
            user-select: none;
        }
        ...
        .kv-controls span {
            cursor: pointer; padding: 0 5px; font-size: 14px; opacity: 0.5; transition: 0.2s;
        }

        .kv-controls span:hover { opacity: 1; color: #8b5cf6; }
    ...
    ui.onmousedown = (e) => {
        if (!isMin && !ui.querySelector('.kv-header').contains(e.target)) return;
        isDragging = true;
        startX = e.clientX;
        startY = e.clientY;
